let lenteDeContactoSeleccionado;
...
export function cargarCliente(data)
{
    ...
    let contenido = "<option value='' selected='' disabled=''>Selecciona al cliente</option>";
    clientes.forEach(function (empleado, index) {
        let registro = "<option value='" + index + "'>" + cliente.persona.nombre + "</option>";
        contenido += registro;
    });
